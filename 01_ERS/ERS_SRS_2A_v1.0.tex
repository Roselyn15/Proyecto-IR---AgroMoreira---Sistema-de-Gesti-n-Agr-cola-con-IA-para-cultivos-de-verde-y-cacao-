...
\hline
Métrica & Proporción de alertas y recomendaciones que incluyen explicación causal y nivel de incertidumbre en su presentación; tiempo adicional de presentación de la explicación; extensión de la explicación; comprensión reportada por el usuario \\
\hline
Valor objetivo & 100~\% de las alertas y recomendaciones incluyen explicación causal y nivel de incertidumbre; tiempo de presentación $\leq$ 1,0 s adicional respecto a la alerta; extensión máxima de 3 líneas de texto; comprensión reportada $\geq$ 4 sobre 5 en escala Likert. \\
\hline
Método de medición & Verificación sobre una muestra de 20 alertas o recomendaciones generadas, y encuesta de comprensión en escala Likert de 5 puntos aplicada al administrador tras presentarle 10 alertas. \\
\hline
